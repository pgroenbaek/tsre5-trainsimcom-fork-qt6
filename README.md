...
**Note:** This is an experimental Qt6-based version of the v0.8.005-RC2 version of the Trainsim.com Fork.

The stable version is [available here](https://github.com/eric-from-trainsim/TSRE5-Trainsim.Com-Fork).
