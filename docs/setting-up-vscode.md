...
To build TSRE5, you will also need to install Qt6 and vcpkg. Paths to the install-locations must also be set up using a `CMakeUserPresets.json` file, as described in the [build manual](/docs/cmake-build-manual.md).